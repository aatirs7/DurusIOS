...
CREATE TABLE `__new_sync_state` (
	...
	`schema_revision` integer DEFAULT 4 NOT NULL
);
...
ALTER TABLE `settings` ADD `typing_only` integer DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE `settings` ADD `drill_direction` text DEFAULT 'both' NOT NULL;